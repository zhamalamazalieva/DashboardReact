       ...
       <section className='manage col-10'>
           ...
           <table className='manage__users users'>
               <tr className='users__row'>
                   <th className='col-3 users__headers'>Selected 2 Users</th>
                   <th className='col-3 users__headers'>Users ID</th>
                   <th className='col-3 users__headers'>Phone Number</th>
                   <th className='col-3 users__headers'>Email Addres</th>
                   <th className='col-1 users__headers'>Account Created</th>
               </tr>   
               <Items users={data}/>           
           </table>
        </section>
